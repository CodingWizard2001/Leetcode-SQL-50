...
-- 1.  pid is the policyholder's policy ID.
-- 2.  tiv_2015 is the total investment value in 2015 and 3.  tiv_2016 is the total investment value in 2016.
-- 4.  lat is the latitude of the policy holder's city. 
-- 5.  It's guaranteed that lat is not NULL.
-- 6.  lon is the longitude of the policy holder's city. 
-- 7.  It's guaranteed that lon is not NULL.
